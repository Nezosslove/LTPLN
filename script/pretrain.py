...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Pretrain ltpln with miniset"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--output_file",
        type=str,
        default=os.path.join(here,"model","ltpln_pretrain"),
    ...
    ltpln.pretrain(model,x_train,y_train,x_val,y_val,args.epoch,args.batch_size,args.output_file)