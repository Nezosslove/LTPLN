...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Train ltpln with miniset"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--output_file",
        type=str,
        default=os.path.join(here,"model","ltpln_new"),
    ...
    if args.path_pretrain_model == 'none':
        ...
        model = ltpln.load_model(args.path_pretrain_model)
    ...
    ltpln.train(model,x_train,y_train,x_val,y_val,args.epoch,args.batch_size,args.output_file)